  ...
  useEffect(() => {
    const fetchLeaderboard = async () => {
      try {
        ...
        const response = await fetch(`/api/leaderboard?time=${timeFilter}&game=${gameFilter}`);
        if (response.ok) {
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="max-w-4xl mx-auto p-4">
        ...
        {user && leaderboard.length > 0 && (
          <div className="mt-6 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg p-4 border border-border">
